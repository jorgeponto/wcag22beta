...
const localizationStrings = {
  ...
  pt: {
    ...
    author: "Autor:",
    authors: "Autores:",
    commit_history: "Histórico de commits",
    edited_in_place: "editado no local",
    editor: "Editor:",
    editors: "Editores:",
    feedback: "Comentários:",
    former_editor: "Antigo editor:",
    former_editors: "Antigos editores:",
    history: "Histórico:",
    implementation_report: "Relatório de implementação:",
    latest_editors_draft: "Rascunho mais recente do editor:",
    latest_published_version: "Última versão publicada:",
    latest_recommendation: "Última Recomendação:",
    message_topic: "… assunto da mensagem …",
    more_details_about_this_doc: "Mais detalhes sobre este documento",
    multiple_alternates(plural) {
      return `Este documento também está disponível ${
        plural ? "nestes formatos não normativos" : "neste formato não normativo"
      }:`;
    },
    prev_editor_draft: "Rascunho anterior do editor:",
    prev_recommendation: "Recomendação anterior:",
    prev_version: "Versão anterior:",
    publication_history: "Histórico de publicação",
    test_suite: "Conjunto de testes:",
    this_version: "Esta versão:",
    with_subject_line: "com o assunto",
    your_topic_here: "O SEU ASSUNTO AQUI",
  },
  ko: {
    author: "저자:",
    authors: "저자:",
