...
const localizationStrings = {
  ...
  pt: {
    sotd: "Estado do Presente Documento",
    status_at_publication: html`Esta secção descreve o estado deste
      documento no momento da sua publicação. Uma lista das publicações atuais do W3C
      e a versão mais recente deste relatório técnico pode ser encontrada
      no <a href="https://www.w3.org/TR/">índice de relatórios técnicos do W3C</a> em
      https://www.w3.org/TR/.`,
  },
  ko: {
    sotd: "현재 문서의 상태",
